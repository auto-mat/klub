    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_bool', models.BooleanField(default=False, help_text='choose if date is visible in specific type of interaction ')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('baseinteraction2_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='interactions.BaseInteraction2')),
                ('date_from', models.DateTimeField(auto_now_add=True, null=True, verbose_name='Date and time of the communication')),
                ('date_to', models.DateTimeField(auto_now_add=True, null=True, verbose_name='Date of creation')),
                ...
                ('next_communication_date', models.DateTimeField(auto_now_add=True, null=True, verbose_name='Date of creation')),
