...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'User.profile_picture'
        db.alter_column(u'aklub_user', 'profile_picture', self.gf('stdimage.fields.StdImageField')(size={'width': 2048, 'force': None, 'height': 2048}, max_length=100, null=True, thumbnail_size={'width': 150, 'force': None, 'height': 150}))
