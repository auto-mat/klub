...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'aklub_user', 'profile_picture', self.gf('stdimage.models.StdImageField')(max_length=100, null=True, variations={'thumbnail': {u'width': 100, u'name': 'thumbnail', u'resample': 1, u'crop': True, u'height': 100}}))
    ...
    models = {
        u'aklub.accountstatements': {
            ...
            'import_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 9, 5, 0, 0)'})
        },
        ...
        u'aklub.payment': {
            'BIC': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
        ...
        u'aklub.recruiter': {
            ...
            'registered': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 9, 5, 0, 0)'}),
        ...
        u'aklub.user': {
            ...
            'profile_picture': ('stdimage.models.StdImageField', [], {'max_length': '100', 'null': 'True', u'variations': "{'thumbnail': {u'width': 100, u'name': 'thumbnail', u'resample': 1, u'crop': True, u'height': 100}}", 'blank': 'True'}),
            ...
            'registered_support': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 5, 0, 0)', 'blank': 'True'}),
