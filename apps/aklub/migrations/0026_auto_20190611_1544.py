# Generated by Django 2.1.7 on 2019-06-11 13:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='payment',
            name='VS2',
            field=models.CharField(blank=True, help_text='Variable symbol 2', max_length=30, null=True, verbose_name='VS 2'),
        ),
        migrations.AlterField(
            model_name='accountstatements',
            name='type',
            field=models.CharField(choices=[('account', 'Account statement - Fio Banka'), ('account_cs', 'Account statement - Česká spořitelna'), ('darujme', 'Darujme.cz')], max_length=20),
        ),
        migrations.RemoveField(
            model_name='donorpaymentchannel',
            name='event',
