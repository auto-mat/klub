...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Condition.on_dashboard'
        db.add_column(u'aklub_condition', 'on_dashboard',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Condition.on_dashboard'
        db.delete_column(u'aklub_condition', 'on_dashboard')
    ...
    models = {
        u'aklub.accountstatements': {
            ...
            'import_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 20, 0, 0)'})
        },
        ...
        u'aklub.recruiter': {
            ...
            'registered': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 20, 0, 0)'}),
        ...
        u'aklub.user': {
            ...
            'registered_support': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 20, 0, 0)', 'blank': 'True'}),
