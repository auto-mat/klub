...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='exceptional_membership',
            field=models.BooleanField(default=False, help_text='In special cases, people can become members of the club even if they do not pay any money. This should be justified in the note.', verbose_name='Exceptional membership'),
        ),
        migrations.AddField(
            model_name='donorpaymentchannel',
            name='expected_date_of_first_payment',
            field=models.DateField(blank=True, help_text='When should the first payment arrive on our account', null=True, verbose_name='Expected date of first payment'),
        ),
        migrations.AddField(
            model_name='donorpaymentchannel',
            name='old_account',
            field=models.BooleanField(default=False, help_text='User has old account', verbose_name='Old account'),
        ),
        migrations.AddField(
            model_name='donorpaymentchannel',
            name='other_support',
            field=models.TextField(blank=True, help_text='If the user supports us in other ways, please specify here.', max_length=500, verbose_name='Other support'),
        ),
        migrations.AddField(
            model_name='donorpaymentchannel',
            name='registered_support',
            field=models.DateTimeField(blank=True, default=django.utils.timezone.now, help_text='When did this user register to support us', verbose_name='Registered support'),
        ),
        migrations.AddField(
            model_name='donorpaymentchannel',
            name='regular_amount',
            field=models.PositiveIntegerField(blank=True, help_text='Minimum yearly payment is 1800 Kč', null=True, verbose_name='Regularly (amount)'),
        ),
        migrations.AddField(
            model_name='donorpaymentchannel',
        ...
        migrations.AddField(
            ...
            field=models.CharField(choices=[('regular', 'Regular payments'), ('onetime', 'No regular payments'), ('promise', 'Promise of regular payments')], default='regular', help_text='Is this user registered for regular payments?', max_length=20, verbose_name='Regular payments'),
        ),
        migrations.AddField(
            model_name='donorpaymentchannel',
            name='user',
