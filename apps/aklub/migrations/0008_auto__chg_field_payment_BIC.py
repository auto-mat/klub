...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Payment.BIC'
        db.alter_column(u'aklub_payment', 'BIC', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

    def backwards(self, orm):

        # Changing field 'Payment.BIC'
        db.alter_column(u'aklub_payment', 'BIC', self.gf('django.db.models.fields.CharField')(default='', max_length=30))
    ...
    models = {
        u'aklub.accountstatements': {
            ...
            'import_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 26, 0, 0)'})
        },
        ...
        u'aklub.recruiter': {
            ...
            'registered': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 26, 0, 0)'}),
        ...
        u'aklub.user': {
            ...
            'registered_support': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 26, 0, 0)', 'blank': 'True'}),
