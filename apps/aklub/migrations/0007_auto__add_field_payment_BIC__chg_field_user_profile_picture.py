...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Payment.BIC'
        db.add_column(u'aklub_payment', 'BIC',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)


        # Changing field 'User.profile_picture'
        db.alter_column(u'aklub_user', 'profile_picture', self.gf('stdimage.fields.StdImageField')(max_length=100, null=True, thumbnail_size={'width': 150, 'force': None, 'height': 150}, size={'width': 2048, 'force': None, 'height': 2048}))

    def backwards(self, orm):
        # Deleting field 'Payment.BIC'
        db.delete_column(u'aklub_payment', 'BIC')


        # Changing field 'User.profile_picture'
        db.alter_column(u'aklub_user', 'profile_picture', self.gf('stdimage.fields.StdImageField')(max_length=100, null=True))
    ...
    models = {
        u'aklub.accountstatements': {
            ...
            'import_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 18, 0, 0)'})
        },
        ...
        u'aklub.communication': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'communications'", 'to': u"orm['aklub.User']"})
        },
        u'aklub.condition': {
        ...
        u'aklub.payment': {
            'BIC': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
        ...
        u'aklub.recruiter': {
            ...
            'registered': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 18, 0, 0)'}),
        ...
        u'aklub.user': {
            'Meta': {'ordering': "('surname', 'firstname')", 'object_name': 'User'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'activity_points': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'campaigns': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'members'", 'blank': 'True', 'to': u"orm['aklub.Campaign']"}),
            ...
            'different_correspondence_address': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '40', 'blank': 'True'}),
            ...
            'old_account': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'profile_picture': ('stdimage.fields.StdImageField', [], {'blank': 'True', 'max_length': '100', 'null': 'True', 'thumbnail_size': "{'width': 150, 'force': None, 'height': 150}", 'size': "{'width': 2048, 'force': None, 'height': 2048}"}),
            ...
            'registered_support': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 18, 0, 0)', 'blank': 'True'}),
