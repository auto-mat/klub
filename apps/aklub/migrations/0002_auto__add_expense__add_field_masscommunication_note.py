...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'aklub_expense', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('amount', self.gf('django.db.models.fields.FloatField')()),
            ('item', self.gf('django.db.models.fields.CharField')(max_length=300, blank=True)),
            ('campaign', self.gf('django.db.models.fields.related.ForeignKey')(related_name='expenses', to=orm['aklub.Campaign'])),
        ))
        db.send_create_signal(u'aklub', ['Expense'])

        # Adding field 'MassCommunication.note'
        db.add_column(u'aklub_masscommunication', 'note',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'aklub_expense')

        # Deleting field 'MassCommunication.note'
        db.delete_column(u'aklub_masscommunication', 'note')
    ...
    models = {
        u'aklub.accountstatements': {
            ...
            'import_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 15, 0, 0)'})
        },
        ...
        u'aklub.recruiter': {
            ...
            'registered': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 15, 0, 0)'}),
        ...
        u'aklub.user': {
            ...
            'registered_support': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 15, 0, 0)', 'blank': 'True'}),
