...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MassCommunication.date'
        db.alter_column(u'aklub_masscommunication', 'date', self.gf('django.db.models.fields.DateField')(default=None))

    def backwards(self, orm):

        # Changing field 'MassCommunication.date'
        db.alter_column(u'aklub_masscommunication', 'date', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    models = {
        u'aklub.accountstatements': {
            ...
            'import_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 3, 0, 0)'})
        },
        ...
        u'aklub.recruiter': {
            ...
            'registered': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 3, 0, 0)'}),
        ...
        u'aklub.user': {
            ...
            'registered_support': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 3, 0, 0)', 'blank': 'True'}),
