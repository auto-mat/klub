...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.different_correspondence_address'
        db.add_column(u'aklub_user', 'different_correspondence_address',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'User.old_account'
        db.add_column(u'aklub_user', 'old_account',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'User.activity_points'
        db.add_column(u'aklub_user', 'activity_points',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.different_correspondence_address'
        db.delete_column(u'aklub_user', 'different_correspondence_address')

        # Deleting field 'User.old_account'
        db.delete_column(u'aklub_user', 'old_account')

        # Deleting field 'User.activity_points'
        db.delete_column(u'aklub_user', 'activity_points')
    ...
    models = {
        u'aklub.accountstatements': {
            ...
            'import_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 11, 0, 0)'})
        },
        ...
        u'aklub.recruiter': {
            ...
            'registered': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 11, 0, 0)'}),
        ...
        u'aklub.user': {
            ...
            'registered_support': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 11, 0, 0)', 'blank': 'True'}),
