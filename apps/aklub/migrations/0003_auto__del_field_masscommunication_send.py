...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MassCommunication.send'
        db.delete_column(u'aklub_masscommunication', 'send')


    def backwards(self, orm):
        # Adding field 'MassCommunication.send'
        db.add_column(u'aklub_masscommunication', 'send',
    ...
    models = {
        u'aklub.accountstatements': {
            ...
            'import_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 19, 0, 0)'})
        },
        ...
        u'aklub.recruiter': {
            ...
            'registered': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 19, 0, 0)'}),
        ...
        u'aklub.user': {
            ...
            'registered_support': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 19, 0, 0)', 'blank': 'True'}),
