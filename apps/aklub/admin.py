...
from django.db.models import CharField, F, Max, Min, OuterRef, Q, Subquery, Sum
...
from .utils import Count, check_annotate_filters, edit_donor_annotate_filter, sweet_text
...
class UserProfileAdmin(
    ...
    advanced_filter_fields_operators = {
        ...
        'country': ('iexact',),
        'zip_code': ('iexact',),
        'correspondence_street': ('iexact',),
        'correspondence_city': ('iexact',),
        'correspondence_country': ('iexact',),
        'correspondence_zip_code': ('iexact',),
