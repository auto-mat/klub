...
class TestStr(TestCase):
    ...
    def test_get_email_str(self):
        ...
        mommy.make(
            "CompanyContact",
            company=c,
            email="test_yes@test.cz",
            is_primary=True,
            administrative_unit=unit1,
        )
        mommy.make(
            "CompanyContact",
            company=c,
            email="test_no@test.cz",
            is_primary=True,
            administrative_unit=unit2,
        )
...
class TestTaxConfirmation(CreateSuperUserMixin, TestCase):
    ...
    def test_generate_pdf_userprofile(self):
        ...
        mommy.make(
            "aklub.TaxConfirmationField",
            pdfsandwich_type=pdf_type,
            field="year",
            font=font,
        )
        mommy.make(
        ...
        self.assertEqual(
            form_data["pdf_type"].form.fields["pdf_type"]._queryset.first().id, 22
        )
